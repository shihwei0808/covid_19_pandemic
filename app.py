...
def filter_global_map(country_names):
    ...
    return fig
with gr.Blocks() as gloal_map_tab:
    ...
    with gr.Column():
        ...
        global_map = gr.Plot()
    gloal_map_tab.load(fn=filter_global_map,
              inputs=countries,
              outputs=global_map)
...
with gr.Blocks() as country_timeseries:
    ...
    def filter_time_series(country):
        ...
        return filtered_df
    country_timeseries.load(fn=filter_time_series,
              inputs=country,
    ...
    country_timeseries.load(fn=filter_time_series,
              inputs=country,
              outputs=plt_doses)
demo = gr.TabbedInterface({gloal_map_tab,country_timeseries},['Gloal Map','Country TimeSeries'])
demo.launch()